    ...
    <main style={styles.page}>
      ...
      <section style={styles.section}>
        ...
        <ul style={styles.list}>
          ...
          <li style={styles.listItem}>
            🐝 <strong>Hive</strong> — a shared space where ideas keep living
      ...
      <section style={styles.section}>
        ...
        <p style={styles.paragraph}>
          ...
          timestamped home — a visible trail of how they evolve from sparks into
          directions.
        </p>
        <p style={styles.paragraph}>
          Instead of chasing applause, Roota tracks the{" "}
          <strong>heartbeat</strong> of ideas: which ones attract energy, which
          ones fade, and where new clusters start to appear.
        </p>
      </section>
      ...
      <section style={styles.section}>
        ...
        <ul style={styles.list}>
          ...
          <li style={styles.listItem}>
            🌐 Matchmaking toolkit for investors and studios
          </li>
        </ul>
        <p style={styles.paragraph}>
          The public idea registry stays open. Paid layers exist only to give
          more leverage to people who work with ideas seriously — not to lock
          anyone out.
        </p>
      </section>
    </main>
